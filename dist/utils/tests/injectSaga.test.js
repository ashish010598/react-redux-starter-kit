...
import * as sagaInjectors from '../sagaInjectors'; // Fixtures
...
describe('injectSaga decorator', () => {
  ...
  it('should inject given saga, mode, and props', () => {
    ...
    shallow( /*#__PURE__*/React.createElement(ComponentWithSaga, props), {
      context: {
        store
      }
    });
  ...
  it('should eject on unmount with a correct saga key', () => {
    ...
    const renderedComponent = shallow( /*#__PURE__*/React.createElement(ComponentWithSaga, props), {
      context: {
        store
      }
    });
  ...
  it('should set a correct display name', () => {
    ...
    expect(injectSaga({
      key: 'test',
      saga: testSaga
    })(() => null).displayName).toBe('withSaga(Component)');
  });
